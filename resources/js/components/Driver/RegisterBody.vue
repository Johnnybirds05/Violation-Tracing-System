    ...
    <v-stepper-content step="3">
        <v-card class="mb-12" color="grey darken-3" height="400px">
            ...
            <div class="container-fluid">
                ...
                <div class="row g-0  centers ">
                    <div class="col-md-3 ml-7">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="flexCheckChecked" data-bs-toggle="modal" data-bs-target="#terms">
                ...
                <v-btn color="light-green darken-3"  data-bs-toggle="modal" data-bs-target="#regDriver">
                    Submit
                </v-btn>
                ...
                <div class="modal fade" id="terms" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
                        ...
                        <div class="modal-body text-white">
                            ...
                            <p>The VAVTS website located at www.vavts.com is a copyrighted work belonging to Vehicle Assistant and Violation Tracing System. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.</p>
                            ...
                            <p><strong>Cookies and Web Beacons.</strong> Like any other website, VAVTS uses ‘cookies’. These cookies are used to store information including visitors’ preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users’ experience by customizing our web page content based on visitors’ browser type and/or other information.</p>
                            ...
                            <p><strong>Notice Requirement and Informal Dispute Resolution.</strong> Before either party may seek arbitration, the party must first send to the other party a written Notice of Dispute describing the nature and basis of the claim or dispute, and the requested relief.  A Notice to the Company should be sent to: Tangub City, Misamis Occidental. After the Notice is received, you and the Company may attempt to resolve the claim or dispute informally.  If you and the Company do not resolve the claim or dispute within thirty (30) days after the Notice is received, either party may begin an arbitration proceeding.  The amount of any settlement offer made by any party may not be disclosed to the arbitrator until after the arbitrator has determined the amount of the award to which either party is entitled.</p>
